...
mplusTimerText:SetFont(addon.FONT_PATH, addon.OBJ_SIZE, "OUTLINE")
...
mplusPctText:SetFont(addon.FONT_PATH, addon.OBJ_SIZE, "OUTLINE")
...
mplusAffixesText:SetFont(addon.FONT_PATH, addon.SECTION_SIZE, "OUTLINE")
